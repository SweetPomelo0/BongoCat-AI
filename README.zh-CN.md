...
<p align="center">
  ...
  会跟着你的键盘、鼠标、手柄互动，也能聊天，并把记忆存到本地 Markdown 文件里。
</p>
...
- 记忆存放在本地 Markdown 文件中
- `PERSONA.md`：人格和说话风格
- `MEMORY.md`：长期稳定记忆
- `daily/YYYY-MM-DD.md`：每日上下文和临时事项
- 用户可以直接查看和编辑这些文件
...
- 不只是动画联动，还可以聊天
- 不只是一次性回复，还可以形成长期记忆
- 不只是黑盒状态，还可以把记忆落到用户可见的本地文件里

目标很简单：
让它更像一只长期陪伴你的桌面角色，而不只是一个主题化聊天 UI。
